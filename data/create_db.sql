...
CREATE UNIQUE INDEX dog_name_uindex ON public.dog (name);
...
CREATE UNIQUE INDEX family_id_uindex ON public.family (id);
CREATE UNIQUE INDEX family_name_uindex ON public.family (name);


ALTER TABLE public.dog
ADD CONSTRAINT dog_family_id_fk
FOREIGN KEY (family_id) REFERENCES public.family (id) ON DELETE CASCADE ON UPDATE CASCADE;
...
CREATE UNIQUE INDEX area_of_origin_id_uindex ON public.area_of_origin (id);
CREATE UNIQUE INDEX area_of_origin_uindex ON public.area_of_origin (name);
...
CREATE UNIQUE INDEX date_of_origin_id_uindex ON public.date_of_origin (id);
CREATE UNIQUE INDEX date_of_origin_name_uindex ON public.date_of_origin (name);
...
CREATE UNIQUE INDEX other_dog_name_id_uindex ON public.other_dog_name (id);
CREATE UNIQUE INDEX other_dog_name_name_uindex ON public.other_dog_name (name);
COMMENT ON TABLE public.other_dog_name IS 'Joined to dog via dog_to_other_dog_name table';
...
CREATE UNIQUE INDEX dog_to_other_dog_name_id_uindex ON public.dog_to_other_dog_name (id);
COMMENT ON TABLE public.dog_to_other_dog_name IS 'joins dog to other dog names';
